...
console.log(answer);`}</code>
        ...
        <p className="text-[15px] text-muted-foreground leading-7 mb-4">
          ...
          used to generate it. <code className="rounded bg-trouve-card px-1.5 py-0.5 text-[13px] text-trouve-teal font-mono border border-trouve-border">subgraph.nodes</code> and{" "}
          <code className="rounded bg-trouve-card px-1.5 py-0.5 text-[13px] text-trouve-teal font-mono border border-trouve-border">subgraph.edges</code> are returned as plain JSON.
        </p>
