  ...
  return (
    <>
      ...
      <DocsPage toc={TOC}>
        ...
        <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-5xl mb-4">Data Intelligence SDK</h1>
        ...
        <p className="text-base text-muted-foreground leading-relaxed mb-4">Two paths from here:</p>
        <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2 text-base leading-relaxed">
          <li>
