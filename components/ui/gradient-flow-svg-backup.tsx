// Backup of the original SVG/Framer-Motion background (pre-WebGL). Not
// imported anywhere - kept only as a reference in case we want the old
// look back. Swapped out for WebThreads in gradient-flow.tsx.
"use client";
